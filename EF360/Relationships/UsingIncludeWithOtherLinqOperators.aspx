<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsingIncludeWithOtherLinqOperators.aspx.cs" Inherits="EF360CodeOnly.Relationships.UsingIncludeWithOtherLinqOperators" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-left: 15px;">
       <div>
        ...
        <asp:GridView ID="gvInclude" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
